...
import ModalBorrowBook from "../components/BorrowReserveManager/ModalBorrowBook";

function BorrowReserveManager() {
  const data = [
    {
      id: 1,
      name: "John Doe",
      ...
      <div className="flex flex-col mt-[10px] space-y-5">
        <div className="justify-between h-[80px] w-full bg-white rounded-md flex">
          <div className="flex justify-center">
            ...
            >
              <AddButton title="Lập phiếu mượn" />
            </div>
            <div
              className="flex justify-center"
              onClick={() => {
...
export default BorrowReserveManager;
